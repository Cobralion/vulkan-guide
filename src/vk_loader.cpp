...
//	{
//		MeshAsset meshAsset{};
//		meshAsset.name = mesh.name.empty() ? "UnnamedMesh" : mesh.name;
//
//		indices.clear();
//		vertices.clear();
//
...
//
//			size_t initialVertx = vertices.size();
//
//			{
...
//					[&](std::uint32_t idx)
//					{
//						indices.push_back(idx + initialVertx);
//					});
//			}
//
//			{
...
//						newvtx.uv_x = 0;
//						newvtx.uv_y = 0;
//						vertices[initialVertx + index] = newvtx;
//					});
//			}
//
//			// load vertex normals
...
//					[&](glm::vec3 v, size_t index) {
//						vertices[initialVertx + index].normal = v;
//					});
//			}
//
//			// load UVs
...
//						vertices[initialVertx + index].uv_x = v.x;
//						vertices[initialVertx + index].uv_y = v.y;
//					});
//			}
//
//			// load vertex colors
...
//						vertices[initialVertx + index].color = v;
//					});
//			}
